            ...
            foreach(DoseObjective DO in PROI)
            {
                ...
                if (DO.type == "cm3")
                {
                    ...
                    {                                                                           //V type limits
                        ...
                        row.Cells[3].AddParagraph(Math.Round(DO.actvol, 2, MidpointRounding.AwayFromZero).ToString() + " cc");
                        row.Cells[4].AddParagraph(DO.status);
                        row.Cells[5].AddParagraph(Math.Round(DO.structvol, 2, MidpointRounding.AwayFromZero).ToString());
                    ...
                    else
                    {
                        ...
                        row.Cells[0].AddParagraph(DO.DoseObjectiveName);
                        row.Cells[1].AddParagraph(Math.Round(DO.limvol, 2, MidpointRounding.AwayFromZero).ToString() + " cc");
                        row.Cells[2].AddParagraph(Math.Round(DO.goalvol, 2, MidpointRounding.AwayFromZero).ToString() + " cc");
                        row.Cells[3].AddParagraph(Math.Round(DO.actvol, 2, MidpointRounding.AwayFromZero).ToString() + " cc");
                        row.Cells[4].AddParagraph(DO.status);
                        row.Cells[5].AddParagraph(Math.Round(DO.structvol, 2, MidpointRounding.AwayFromZero).ToString());
                ...
                else if (DO.type == "percent")
                {
                    ...
                    {                                                                           //V type limits
                        ...
                        row.Cells[1].AddParagraph("NA");
                        row.Cells[2].AddParagraph("NA");
                        row.Cells[3].AddParagraph(Math.Round(DO.actvol, 2, MidpointRounding.AwayFromZero).ToString() + " %");
                        row.Cells[4].AddParagraph(DO.status);
                        row.Cells[5].AddParagraph(Math.Round(DO.structvol, 2, MidpointRounding.AwayFromZero).ToString());
                    }
                    else
                    {
                        row.Cells[0].AddParagraph(DO.DoseObjectiveName);
                        row.Cells[1].AddParagraph(Math.Round(DO.limvol, 2, MidpointRounding.AwayFromZero).ToString() + " %");
                        row.Cells[2].AddParagraph(Math.Round(DO.goalvol, 2, MidpointRounding.AwayFromZero).ToString() + " %");
                        row.Cells[3].AddParagraph(Math.Round(DO.actvol, 2, MidpointRounding.AwayFromZero).ToString() + " %");
                        row.Cells[4].AddParagraph(DO.status);
                        row.Cells[5].AddParagraph(Math.Round(DO.structvol, 2, MidpointRounding.AwayFromZero).ToString());
                    }
