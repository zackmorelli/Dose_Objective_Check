...
namespace DoseObjectiveCheck
{
    public partial class ConventionalDoseCoverageTargetSelector : Form
    {
        ...
        void LAMBDALINK(object sender, EventArgs e, ConventionalCoverageStats conventionalCoverageStats)
        {
            if (conventionalCoverageStats.Sequential == false)
            {
                if (t1list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t1list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox1.Text), plan = "NA" });
                }

                if (t2list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t2list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox2.Text), plan = "NA" });
                }

                if (t3list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t3list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox3.Text), plan = "NA" });
                }

                if (t4list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t4list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox4.Text), plan = "NA" });
                }

                if (t5list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t5list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox5.Text), plan = "NA" });
                }

                if (t6list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t6list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox6.Text), plan = "NA" });
                }

                if (t7list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t7list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox7.Text), plan = "NA" });
                }

                if (t8list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t8list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox8.Text), plan = "NA" });
                }

                if (t9list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t9list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox9.Text), plan = "NA" });
                }

                if (t10list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t10list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox10.Text), plan = "NA" });
                }
            }
            else if(conventionalCoverageStats.Sequential == true)
            {
                if (t1list.SelectedItem.ToString() != "NA")
                {
                     conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t1list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox1.Text), plan = p1list.SelectedItem.ToString() });
                }

                if (t2list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t2list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox2.Text), plan = p2list.SelectedItem.ToString() });
                }

                if (t3list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t3list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox3.Text), plan = p3list.SelectedItem.ToString() });
                }

                if (t4list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t4list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox4.Text), plan = p4list.SelectedItem.ToString() });
                }

                if (t5list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t5list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox5.Text), plan = p5list.SelectedItem.ToString() });
                }

                if (t6list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t6list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox6.Text), plan = p6list.SelectedItem.ToString() });
                }

                if (t7list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t7list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox7.Text), plan = p7list.SelectedItem.ToString() });
                }

                if (t8list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t8list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox8.Text), plan = p8list.SelectedItem.ToString() });
                }

                if (t9list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t9list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox9.Text), plan = p9list.SelectedItem.ToString() });
                }

                if (t10list.SelectedItem.ToString() != "NA")
                {
                    conventionalCoverageStats.TargetStructures.Add(new TargetStructure { StructureNAME = t10list.SelectedItem.ToString(), Dose = Convert.ToDouble(Dbox10.Text), plan = p10list.SelectedItem.ToString() });
                }
